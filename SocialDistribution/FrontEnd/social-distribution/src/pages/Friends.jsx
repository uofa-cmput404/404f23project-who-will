...
class Friends extends Component {
  ...
  async componentDidMount() {
    ...
    getFriends = async () => {
       ...
       await getAllFriendsInstance.GetAllFriends(currentUserID)
       .then( friendsList => {
          ...
          friendsList.forEach(id => {
              ...
              .then((res) => {
                  ...
                  if(usrList.length === lengthFriends) {
                      ...
                      this.setState({ done: this.done, usernameList: this.usernameList });
          ...
          const divs = myArray.map((item, index) => {
              ...
              return (  
                <div key={index} className={uniqueClassName}>
                  ...
                  <div className="messageButton" onClick={this.handleProfileClick.bind(this,index)}>View Profile</div>
